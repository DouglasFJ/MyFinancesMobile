...
export default function HomeIcon(
    ...
    <path d="M0 40H8L8 76C8 78.2091 6.20914 80 4 80C1.79086 80 0 78.2091 0 76L0 40Z" fill="${color}"/>
    <path d="M72 40H80V76C80 78.2091 78.2091 80 76 80C73.7909 80 72 78.2091 72 76V40Z" fill="${color}"/>
    <path d="M32 63C32 58.5817 35.5817 55 40 55C44.4183 55 48 58.5817 48 63V80H32V63Z" fill="${color}"/>
    </g>
    <defs>
